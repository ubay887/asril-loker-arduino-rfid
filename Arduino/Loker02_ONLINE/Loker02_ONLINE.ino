...
void setup() {
 ...
 // pinMode(pinSensor, INPUT_PULLUP);
  ...
  HTTPClient http;
  http.begin("http://tugasakhirloker.000webhostapp.com/loker1.php");
...
//                delay(1000);
       ...
       Serial.print("UID Buka :");
        ...
        uidBuka = "";
          ...
          lcd.print("Mohon tunggu");
          delay(2000);
          String url = "/write-data.php?loker=2&&status=DIGUNAKAN&&idkartu="+uidBuka;
          ...
          String url2 = "/cekloker2.php?chip="+uidBuka;
...
//
         ...
         uidTutup = "";
          ...
          // Isi Konten yang dikirim adalah alamat ip si esp -----------------------------
            ...
            String url = "/write-data.php?loker=2&&status=SELESAI&&idkartu="+uidTutup;
...
//    delay(5000);
     // Isi Konten yang dikirim adalah alamat ip si esp -----------------------------
      ...
      String url = "/update-data.php?status=TERBUKA&&loker=2";
...
//    delay(5000);
       ...
       String url = "/update-data.php?status=TERTUTUP&&loker=2";
